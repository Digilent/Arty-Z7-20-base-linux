 ...
 */
#define CPPSTDIN "arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -marm -mfpu=neon  -mfloat-abi=hard -mcpu=cortex-a9  -E"
#define CPPMINUS "-"
#define CPPRUN "arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -marm -mfpu=neon  -mfloat-abi=hard -mcpu=cortex-a9  -E"
#define CPPLAST "-"
